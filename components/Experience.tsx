    ...
    roles: [
      {
        ...
        location: "United States",
        bullets: [
          "Founded NodeDa, an independent consultancy providing product strategy and experience design support to small businesses and early-stage products.",
          "Lead discovery-through-delivery engagements: research, prioritization, wireframes, prototypes, and delivery-ready design assets - using AI to increase exploration speed and delivery output.",
          "Developed and launched Kinlily (formerly Cookbook), an independent iOS app - hands-on product lifecycle ownership, iteration, and user engagement.",
        ],
      },
    ],
  },
