    ...
    roles: [
      {
        ...
        bullets: [
          ...
          "Developed and launched an independent iOS application (Cookbook), gaining hands-on experience in product lifecycle ownership, iteration, and user engagement.",
        ],
      },
    ],
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-16">
          {experiences.map((exp, expIndex) => (
            ...
            >
              <div className="bg-white dark:bg-black p-8 md:p-10 rounded-2xl shadow-lg border border-[var(--border-light)]">
                <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold text-[var(--text-primary)] dark:text-[var(--text-primary)] mb-2 flex items-center gap-3">
                      <Briefcase className="w-6 h-6 text-[var(--primary)]" aria-hidden="true" />
                      {exp.company}
                    </h3>
